use super::{ConnecterKind, RedirectList, Unit, UnitKind, Word, WordList};
...
fn pp_unit(unit: &Unit, indent: usize) {
    ...
    match &unit.kind {
        ...
        UnitKind::Pipe { left, right, both } => print_pipe(indent, left, right, both, background),
        UnitKind::If {
            condition,
            true_case,
            false_case,
